...
<div class="auth-page-wrapper">
    ...
    <div class="auth-left">
        ...
        <div class="auth-form-section">
            ...
            <!-- Tabs -->
            <div class="auth-tabs">
                <a href="<?php echo BASE_URL; ?>views/user/login.php" class="auth-tab active">Log In</a>
                <a href="<?php echo BASE_URL; ?>views/user/register.php" class="auth-tab">Sign Up</a>
            </div>
            ...
            <!-- Login Form -->
            <form id="loginForm" method="POST" action="<?php echo BASE_URL; ?>controllers/AuthController.php">
            ...
            <p class="auth-footer-link">
                Don't have an account? <a href="<?php echo BASE_URL; ?>views/user/register.php">Sign Up</a>
            </p>
...
$(document).ready(function() {
    ...
    $('#loginForm').on('submit', async function(e) {
        ...
        $btn.prop('disabled', true).html('<span class="auth-spinner"></span> Signing in...');
        ...
        try {
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    // If server returned a redirect (non-JSON), follow it
                    if (xhr.responseJSON) {
